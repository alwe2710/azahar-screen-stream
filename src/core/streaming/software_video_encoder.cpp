...
// Scaled down from Cemu's own port of this file (4000 kbps at 854x480):
// N3DS_BOTTOM_SCREEN is a fixed 320x240, roughly 1/8th the pixel area, so
// good-quality output needs proportionally less bitrate to stay well under
// typical home Wi-Fi throughput -- same reasoning, smaller picture. Both
// codecs share one value for now; H.265's better efficiency means it could
// go lower, but starting equal keeps this easy to reason about while
// tuning.
